...
namespace Cuisine.Windows
{
    ...
    public class XmlWindowsManagerSerializer : WindowsManagerSerializer
    {
        ...
        {
            Cuisine.Utilities.Validate.NotNull(dockPaneWriter, "dockPaneWriter");
            Cuisine.Utilities.Validate.NotNull(documentWriter, "documentWriter");
        ...
        protected override void InitializeHeaders()
        {
            ...
            Cuisine.Utilities.Validate.NotNull(_document.DocumentElement, "WindowsManager");
            XmlElement rootElement = _elementStack.Peek();
            Cuisine.Utilities.Validate.Assert<InvalidOperationException>((rootElement == _document.DocumentElement) && (rootElement.Name == "WindowsManager"));
        ...
        protected override void WriteHeaderPanes(IEnumerable<DockPane> panes, Dock headerDock)
        {
            ...
            Cuisine.Utilities.Validate.Assert<InvalidOperationException>(headersElement.Name == "Headers");
        ...
        protected override void WritePinnedPanes(IEnumerable<DockPane> panes, Dock headerDock)
        {
            ...
            Cuisine.Utilities.Validate.Assert<InvalidOperationException>(pinnedPanesElement.Name == "PinnedPanes");
