...
namespace Cuisine.Windows
{
    ...
    {
        // TODO : see example in PaintualUI.DockTest.xaml.cs to see how to implement serialization in UI
        ...
        {
            Cuisine.Utilities.Validate.NotNull(dockPaneReader, "dockPaneReader");
        ...
        protected override void ReadWindowsManager()
        {
            ...
            Cuisine.Utilities.Validate.Assert<NullReferenceException>(windowsManagerElement != null);
            Cuisine.Utilities.Validate.Assert<InvalidOperationException>(windowsManagerElement.Name == "WindowsManager");
        ...
        protected override IEnumerable<DockPane> ReadHeaderPanes(Dock dock)
        {
            ...
            Cuisine.Utilities.Validate.Assert<InvalidOperationException>(rootElement.Name == "WindowsManager");
        ...
        protected override DocumentContainerState InitializeDocumentContainer(DocumentContainer documentContainer)
        {
            ...
            Cuisine.Utilities.Validate.Assert<InvalidOperationException>(_documentContainerToDefinitionMapping.TryGetValue(documentContainer, out documentContainerElement) && 
        ...
        protected override void ReadDocuments(DocumentContainer documentContainer)
        {
            ...
            Cuisine.Utilities.Validate.Assert<InvalidOperationException>(documentContainerElement.Name == "DocumentContainer");
        ...
        protected override void InitializeSplit(DocumentContainer parentContainer)
        {
            ...
            Cuisine.Utilities.Validate.Assert<NullReferenceException>(splitElement != null);
            Cuisine.Utilities.Validate.Assert<InvalidOperationException>(splitElement.Name == "Split");
        ...
        {
            Cuisine.Utilities.Validate.Assert<InvalidOperationException>(_elementStack.Count > 0);
        }
        ...
        {
            ValidateStackNotEmpty();
            Cuisine.Utilities.Validate.Assert<InvalidOperationException>(_elementStack.Peek().Name == elementName);
            _elementStack.Pop();
        }
