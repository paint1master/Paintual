...
namespace Cuisine.Windows
{
    ...
    public abstract class WindowsManagerDeserializer
    {
        ...
        {
            Cuisine.Utilities.Validate.NotNull(stream, "stream");
            Cuisine.Utilities.Validate.NotNull(windowsManager, "windowsManager");
            Cuisine.Utilities.Validate.Assert<InvalidOperationException>(stream.CanRead);
        ...
        private void TransferDocumentGrid(WindowsManager windowsManager, bool isHorizontal)
        {
            ...
            Cuisine.Utilities.Validate.Assert<ArgumentNullException>(contentGrid != null);
