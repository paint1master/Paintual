...
Code taken from this project : https://www.codeproject.com/Articles/35436/Adobe-Color-Picker-Clone
...
namespace Engine.Color.Models
{
    ...
    public struct XYZ
    {
        ...
        {
            _x = Engine.Calc.Math.ClipValue(x, 0.0, 95.047);
            _y = Engine.Calc.Math.ClipValue(y, 0.0, 100.000);
            _z = Engine.Calc.Math.ClipValue(z, 0.0, 108.883);
        }
        public static XYZ FromRGB(RGBdouble value)
        {
            double
        ...
        {
            get { return _x; }
            set { _x = Engine.Calc.Math.ClipValue(value, 0.0, 95.047); }
        }
        public double Y
        {
            get { return _y; }
            set { _y = Engine.Calc.Math.ClipValue(value, 0.0, 100.000); }
        }
        public double Z
        {
            get { return _z; }
            set { _z = Engine.Calc.Math.ClipValue(value, 0.0, 108.883); }
        }
        #endregion
    }
    public struct RGBdouble
    {
        ...
        {
            _r = Engine.Calc.Math.ClipValue(r, 0.0, 1.0);
            _g = Engine.Calc.Math.ClipValue(g, 0.0, 1.0);
            _b = Engine.Calc.Math.ClipValue(b, 0.0, 1.0);
        }
        public RGBdouble(System.Drawing.Color value) :
            this(
        ...
        public RGBdouble(Engine.Color.Cell c) :
            this(
                (double)(c.Red) / 255.0,
        ...
        #endregion
        #region operators
        public static bool operator ==(RGBdouble a, RGBdouble b)
        {
            return
                a._r == b._r &&
                a._g == b._g &&
        ...
        #endregion
        #region conversion
        public static implicit operator System.Drawing.Color(RGBdouble value)
        {
            return value.ToArgb();
        }
        public static implicit operator RGBdouble(System.Drawing.Color value)
        {
            return new RGBdouble(value);
        }
        ...
        {
            get { return _r; }
            set { _r = Engine.Calc.Math.ClipValue(value, 0.0, 1.0); }
        }
        public double G
        {
            get { return _g; }
            set { _g = Engine.Calc.Math.ClipValue(value, 0.0, 1.0); }
        }
        public double B
        {
            get { return _b; }
            set { _b = Engine.Calc.Math.ClipValue(value, 0.0, 1.0); }
        }
        #endregion
    }
    public struct LAB
    {
        ...
        {
            _l = Engine.Calc.Math.ClipValue(l, 0.0, 100.0);
            _a = Engine.Calc.Math.ClipValue(a, -128.0, 128.0);
            _b = Engine.Calc.Math.ClipValue(b, -128.0, 128.0);
        }
        ...
        {
            get { return _l; }
            set { _l = Engine.Calc.Math.ClipValue(value, 0.0, 100.0); }
        }
        public double a
        {
            get { return _a; }
            set { _a = Engine.Calc.Math.ClipValue(value, -128.0, 127.0); }
        }
        public double b
        {
            get { return _b; }
            set { _b = Engine.Calc.Math.ClipValue(value, -128.0, 127.0); }
        }
        #endregion
    }
    public struct HSV
    {
        ...
        {
            _h = Engine.Calc.Math.ClipValue(h, 0.0, 1.0);
            _s = Engine.Calc.Math.ClipValue(s, 0.0, 1.0);
            _v = Engine.Calc.Math.ClipValue(v, 0.0, 1.0);
        }
        public static HSV FromRGB(RGBdouble col)
        {
            double
        ...
        #endregion
        #region conversion
        public RGBdouble ToRGB()
        {
            if (_s == 0.0)
            {
                return new RGBdouble(_v, _v, _v);
            }
            else
            {
                double h = _h * 6.0;
        ...
        {
            get { return _h; }
            set { _h = Engine.Calc.Math.ClipValue(value, 0.0, 1.0); }
        }
        public double S
        {
            get { return _s; }
            set { _s = Engine.Calc.Math.ClipValue(value, 0.0, 1.0); }
        }
        public double V
        {
            get { return _v; }
            set { _v = Engine.Calc.Math.ClipValue(value, 0.0, 1.0); }
        }
        #endregion
    }
    public struct CMYK
    {
        ...
        {
            _c = Engine.Calc.Math.ClipValue(c, 0.0, 1.0);
            _m = Engine.Calc.Math.ClipValue(m, 0.0, 1.0);
            _y = Engine.Calc.Math.ClipValue(y, 0.0, 1.0);
            _k = Engine.Calc.Math.ClipValue(k, 0.0, 1.0);
        }
        public static CMYK FromRGB(RGBdouble value)
        {
            double
                c = 1.0 - value.R,
                m = 1.0 - value.G,
        ...
        public RGBdouble ToRGBdouble()
        {
            ...
            return new RGBdouble(1.0 - c, 1.0 - m, 1.0 - y);
        }
        public override string ToString()
        {
        ...
        {
            get { return _c; }
            set { _c = Engine.Calc.Math.ClipValue(value, 0.0, 1.0); }
        }
        public double M
        {
            get { return _m; }
            set { _m = Engine.Calc.Math.ClipValue(value, 0.0, 1.0); }
        }
        public double Y
        {
            get { return _y; }
            set { _y = Engine.Calc.Math.ClipValue(value, 0.0, 1.0); }
        }
        public double K
        {
            get { return _k; }
            set { _k = Engine.Calc.Math.ClipValue(value, 0.0, 1.0); }
        }
        #endregion
    }
}
